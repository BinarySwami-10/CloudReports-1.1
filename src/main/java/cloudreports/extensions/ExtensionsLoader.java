...
/**
 * Provides static methods that load user-implemented extensions using the Java
 * Reflection API. It is entirely based on the content of the
 * extensions/classnames.xml file.
 * 
 * @author Thiago T. Sá
 * @since 1.0
 */
public class ExtensionsLoader {
	 ...
	 * @throws IOException if the system classloader could not load the extension.
	 * @since 1.0
	 */
	...
	/**
	 * Gets the aliases of all extension implementations of a given base class. It
	 * reads the classnames.xml file to get the list of aliases.
	 *
	 * @param type the type of the extension.
	 * @return a list of aliases of all extension implementations of the given base
	 *         class.
	 * @since 1.0
	 */
	public static List<String> getExtensionsAliasesByType(String type) {
		List<String> listAliases = new ArrayList<String>();
		if (classnamesXml == null)
			return listAliases;
	...
	/**
	 * Gets a specific user-implemented extension object based on its base class and
	 * its alias.
	 *
	 * @param type                 the type of the extension.
	 ...
	 *                             extension class.
	 * @param constructorArguments the arguments to be used in the constructor of
	 *                             the extension class.
	 * @return an instance of the extension class.
	 * @since 1.0
	 */
	public static Object getExtension(String type, String alias, Class<?>[] constructorTypes,
		...
		try {
			...
			if (constructorTypes != null && constructorArguments != null)
				return ClassLoader.getSystemClassLoader().loadClass(classname).getConstructor(constructorTypes)
	...
	/**
	 * Gets the name of the file that contains the extension class based on the base
	 * classname and the extension alias. It reads the classnames.xml file to get
	 * name of the file.
	 *
	 * @param type  the type of the extension.
	 * @param alias the alias of the extension.
	 * @return the name of the file that contains the extension class.
	 * @since 1.0
	 */
	...
	/**
	 * Gets the classname of a extension class based on its base classname and its
	 * alias. It reads the classnames.xml file to get classname.
	 *
	 * @param type  the type of the extension.
	 * @param alias the alias of the extension.
	...
	/**
	 * Loads an instance of <code>Document</code> that contains the classnames.xml
	 * file.
	 *
