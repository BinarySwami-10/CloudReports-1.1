...
/**
 * A subtype of CloudSim's VmAllocationPolicySimple class. All user-implemented
 * new virtual machine allocation policies must be a subtype of this class.
 * 
...
public interface VmAllocationPolicyExtensible {
	...
	/**
	 * A method whose implementations must optimize the allocation of virtual
	 * machines.
	 *
	 * @param vmList a list of virtual machines whose allocation must be optimized.
