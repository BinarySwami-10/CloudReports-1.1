...
/**
 * Provides a set of static high level methods related to the settings of the
 * application.
 * 
 * @author Thiago T. Sá
 * @since 1.1
...
public class SettingBusiness {
	...
	public static boolean isHtmlReportsEnabled() {
		...
		if (htmlReportsEnabled == null) {
			...
			return Boolean.valueOf(htmlReportsEnabled.getValue());
	...
	public static boolean isRawDataReportsEnabled() {
		...
		if (rawDataReportsEnabled == null) {
			...
			return Boolean.valueOf(rawDataReportsEnabled.getValue());
	}
