...
public class ReportData {
	...
	/**
	 * Creates a new piece of data reporting reporting resource utilization of a
	 * specific host or virtual machine.
	 *
	 ...
	 * @since 1.0
	 */
	public ReportData(String type, String datacenterName, String customerName, Integer hostId, Integer vmId,
	...
	/**
	 * Creates a new piece of data reporting reporting overall resource utilization
	 * of a datacenter or a customer.
	 *
	 * @param type           the type of resource.
	 * @param datacenterName the datacenter's name.
	 * @param customerName   the customer's name.
	 ...
	 * @since 1.0
	 */
	public ReportData(String type, String datacenterName, String customerName, double time, double amount,
			int simulationId) {
		this.type = type;
		this.datacenterName = datacenterName;
		this.customerName = customerName;
