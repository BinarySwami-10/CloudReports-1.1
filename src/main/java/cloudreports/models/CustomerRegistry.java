...
/**
 * A customer registry stores information about a specific customer. It contains
 * the list of virtual machines owned by the customer as well as its resources
 * utilization profile.
 *
 * @author Thiago T. Sá
 * @since 1.0
