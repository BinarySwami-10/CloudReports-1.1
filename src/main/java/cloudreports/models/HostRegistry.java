...
/**
 * A host registry stores information about a specific host configuration. It
 * contains general information such as scheduling policy, power specifications
...
public class HostRegistry implements Serializable {
	...
	/**
	 * The amount of hosts with this registry's specification owned by the
	 * datacenter.
	 */
	private int amount;
	 ...
	 * @return <code>true</code> if the host can allocate the virtual machine;
	 *         <code>false</code> otherwise.
	 * @since 1.0
	 */
	public boolean canRunVM(VirtualMachineRegistry vmr) {
		if ((this.getRam() < vmr.getRam()) || ((this.getNumOfPes() * this.getMipsPerPe()) < vmr.getMips()) || (this.getBw() < vmr.getBw()) || (this.getStorage() < vmr.getSize()))
			return false;
