...
/**
 * A migration represents the act of deallocating a virtual machine from a host
 * and allocating the same virtual machine to another host. This class stores
 * basic information about the execution of a virtual machine migration.
 *
 * @author Thiago T. Sá
 * @since 1.0
 */
public class Migration {
	...
	/**
	 * The power consumption of the source host on the moment the migration
	 * occurred.
	 */
	...
	/**
	 * The power consumption of the target host on the moment the migration
	 * occurred.
	 */
	 ...
	 * @since 1.0
	 */
	public Migration(VmAllocationPolicy vmAllocationPolicy, PowerHost targetHost, PowerHost sourceHost, Vm vm,
	 ...
	 *
	 * @param sourceHostCpuUtilization the CPU utilization of the source host.
	 */
	 ...
	 *
	 * @param sourceHostPowerConsumption the power consumption of the source host.
	 */
	 ...
	 *
	 * @param targetHostCpuUtilization the CPU utilization of the target host.
	 */
	 ...
	 *
	 * @param targetHostRamUtilization the RAM utilization of the target host.
	 */
	 ...
	 *
	 * @param targetHostPowerConsumption the power consumption of the target host.
	 */
