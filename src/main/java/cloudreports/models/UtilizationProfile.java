...
/**
 * Represents the resources utilization profile of a customer. It stores the
 * customer's broker policy, cloudlets configuration and utilization models.
 *
 * @author Thiago T. Sá
 * @since 1.0
 */
public class UtilizationProfile implements Serializable {
	 ...
	 *
	 * @param pesNumber the number of processing elements required to run a
	 *                  cloudlet.
	 */
	 ...
	 *
	 * @param utilizationModelBwAlias the profile's bandwidth utilization model.
	 */
