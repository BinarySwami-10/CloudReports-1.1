...
/**
 * A datacenter registry stores information about a specific datacenter. It
 * contains the list of hosts owned by the datacenter, cost values and other
...
public class DatacenterRegistry implements Serializable {
	 ...
	 *
	 * @param vmMigration indicates if virtual machines migrations are enabled or
	 *                    not
	 */
