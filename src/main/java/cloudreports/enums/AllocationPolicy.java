...
public enum AllocationPolicy implements Serializable {
	...
	/**
	 * The single threshold allocation policy. Its
	 * {@link #getPolicy(java.util.List, double, java.lang.String)} method returns
	 * an instance of {@link VmAllocationPolicySingleThreshold}.
	 * 
	...
	SINGLE_THRESHOLD {
		...
		public VmAllocationPolicy getPolicy(List<PowerHost> hostList, double upperUtilizationThreshold,
				double lowerUtilizationThreshold, double schedulingInterval, String policyAlias) {
	...
	EXTENSION {
		...
		public VmAllocationPolicy getPolicy(List<PowerHost> hostList, double upperUtilizationThreshold,
			...
			try {
				...
				Object[] arguments = new Object[] { hostList, upperUtilizationThreshold, lowerUtilizationThreshold,
						schedulingInterval };
				return (VmAllocationPolicy) ExtensionsLoader.getExtension("VmAllocationPolicy", policyAlias, types,
						arguments);
			} catch (Exception e) {
				return null;
			}
	...
	/**
	 * An abstract getter method to be implemented by every
	 * {@link AllocationPolicy}.
	 *
	...
	public static AllocationPolicy getInstance(String policyAlias) {
		if (policyAlias.equals("Single threshold"))
			return AllocationPolicy.SINGLE_THRESHOLD;
		else
			return AllocationPolicy.EXTENSION;
	}

	/**
	 * Gets all active allocation policies aliases.
	 *
	 * @return an array of strings containing all active allocation policies
	 *         aliases.
	 * @since 1.0
	 */
