...
/**
 * Defines native types of RAM provisioners and implements an extension type to
...
public enum RamProvisioner {
	...
	/**
	 * The simple provisioner. Its {@link #getProvisioner(int, java.lang.String)}
	 * method returns an instance of CloudSim's RamProvisionerSimple class.
	 */
	SIMPLE {
		@Override
		public org.cloudbus.cloudsim.provisioners.RamProvisioner getProvisioner(int availableRam,
				String provisionerAlias) {
	...
	EXTENSION {
		...
		public org.cloudbus.cloudsim.provisioners.RamProvisioner getProvisioner(int availableRam,
			...
			try {
				...
				return (org.cloudbus.cloudsim.provisioners.RamProvisioner) ExtensionsLoader
						.getExtension("RamProvisioner", provisionerAlias, types, arguments);
			} catch (Exception e) {
				return null;
			}
		}
	 ...
	 * @since 1.0
	 */
	public abstract org.cloudbus.cloudsim.provisioners.RamProvisioner getProvisioner(int availableRam,
			String provisionerAlias);
	...
	public static RamProvisioner getInstance(String provisionerAlias) {
		if (provisionerAlias.equals("Simple"))
			return RamProvisioner.SIMPLE;
		else
			return RamProvisioner.EXTENSION;
	}

	/**
	 * Gets all active RAM provisioners aliases.
	 *
	 * @return an array of strings containing all active RAM provisioners aliases.
	 * @since 1.0
	 */
