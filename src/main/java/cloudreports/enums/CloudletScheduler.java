...
public enum CloudletScheduler implements Serializable {
	...
	/**
	 * The space-shared cloudlet scheduler. Its
	 * {@link #getScheduler(double, int, java.lang.String)} method returns an
	 * instance of CloudSim's CloudletSchedulerSpaceShared class.
	 */
	SPACE_SHARED {
		@Override
	...
	/**
	 * The time-shared cloudlet scheduler. Its
	 * {@link #getScheduler(double, int, java.lang.String)} method returns an
	 * instance of CloudSim's CloudletSchedulerTimeShared class.
	 */
	TIME_SHARED {
		@Override
		public org.cloudbus.cloudsim.CloudletScheduler getScheduler(double mips, int pes, String schedulerAlias) {
	...
	/**
	 * The dynamic workload cloudlet scheduler. Its
	 * {@link #getScheduler(double, int, java.lang.String)} method returns an
	 * instance of {@link CloudletSchedulerDynamicWorkload}.
	 * 
	...
	EXTENSION {
		...
		public org.cloudbus.cloudsim.CloudletScheduler getScheduler(double mips, int pes, String schedulerAlias) {
			try {
				...
				return (org.cloudbus.cloudsim.CloudletScheduler) ExtensionsLoader.getExtension("CloudletScheduler",
						schedulerAlias, types, arguments);
			} catch (Exception e) {
				return null;
			}
		}
	...
	public static CloudletScheduler getInstance(String schedulerAlias) {
		if (schedulerAlias.equals("Time shared"))
			return CloudletScheduler.TIME_SHARED;
		else if (schedulerAlias.equals("Space shared"))
			return CloudletScheduler.SPACE_SHARED;
		else if (schedulerAlias.equals("Dynamic workload"))
			return CloudletScheduler.DYNAMIC_WORKLOAD;
		else
			return CloudletScheduler.EXTENSION;
	}

	/**
	 * Gets all active cloudlet scheduler aliases.
	 *
	 * @return an array of strings containing all active cloudlet scheduler aliases.
	 * @since 1.0
	 */
