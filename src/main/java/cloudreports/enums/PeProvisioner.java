...
public enum PeProvisioner {
	...
	/**
	 * The simple provisioner. Its {@link #getProvisioner(double, java.lang.String)}
	 * method returns an instance of CloudSim's PeProvisionerSimple class.
	 */
	SIMPLE {
		@Override
	...
	EXTENSION {
		...
		public org.cloudbus.cloudsim.provisioners.PeProvisioner getProvisioner(double mips, String provisionerAlias) {
			try {
				...
				return (org.cloudbus.cloudsim.provisioners.PeProvisioner) ExtensionsLoader.getExtension("PeProvisioner",
	 ...
	 * @since 1.0
	 */
	public abstract org.cloudbus.cloudsim.provisioners.PeProvisioner getProvisioner(double mips,
	...
	public static PeProvisioner getInstance(String provisionerAlias) {
		if (provisionerAlias.equals("Simple"))
			return PeProvisioner.SIMPLE;
		else
			return PeProvisioner.EXTENSION;
	}
