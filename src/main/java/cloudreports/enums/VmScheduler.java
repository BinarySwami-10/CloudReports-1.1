...
public enum VmScheduler implements Serializable {
	...
	/**
	 * The space-shared virtual machines scheduler. Its
	 * {@link #getScheduler(java.util.List, java.lang.String)} method returns an
	 * instance of CloudSim's VmSchedulerSpaceShared class.
	 */
	SPACE_SHARED {
		@Override
	...
	/**
	 * The time-shared virtual machines scheduler. Its
	 * {@link #getScheduler(java.util.List, java.lang.String)} method returns an
	 * instance of CloudSim's VmSchedulerTimeShared class.
	 */
	TIME_SHARED {
		@Override
		public org.cloudbus.cloudsim.VmScheduler getScheduler(List<Pe> peList, String schedulerAlias) {
	...
	EXTENSION {
		...
		public org.cloudbus.cloudsim.VmScheduler getScheduler(List<Pe> peList, String schedulerAlias) {
			try {
				...
				return (org.cloudbus.cloudsim.VmScheduler) ExtensionsLoader.getExtension("VmScheduler", schedulerAlias,
						types, arguments);
			} catch (Exception e) {
				return null;
			}
	 ...
	 *
	 * @param peList         the list of processing elements available to the
	 *                       scheduler.
	...
	public static VmScheduler getInstance(String schedulerAlias) {
		if (schedulerAlias.equals("Space shared"))
			return VmScheduler.SPACE_SHARED;
		else if (schedulerAlias.equals("Time shared"))
			return VmScheduler.TIME_SHARED;
		else
			return VmScheduler.EXTENSION;
	}

	/**
	 * Gets all active virtual machines schedulers aliases.
	 *
	 * @return an array of strings containing all active virtual machines schedulers
	 *         aliases.
	 * @since 1.0
	 */
