...
public enum UtilizationModel implements Serializable {
	...
	/**
	 * The full utilization model. Its {@link #getModel()} method returns an
	 * instance of CloudSim's UtilizationModelFull class.
	 */
	FULL {
		@Override
	...
	/**
	 * The stochastic utilization model. Its {@link #getModel()} method returns an
	 * instance of CloudSim's UtilizationModelStochastic class.
	 */
	STOCHASTIC {
		@Override
		public org.cloudbus.cloudsim.UtilizationModel getModel(String modelAlias) {
	...
	EXTENSION {
		...
		public org.cloudbus.cloudsim.UtilizationModel getModel(String modelAlias) {
			try {
				...
				return (org.cloudbus.cloudsim.UtilizationModel) ExtensionsLoader.getExtension("UtilizationModel",
	...
	public static UtilizationModel getInstance(String modelAlias) {
		if (modelAlias.equals("Full"))
			return UtilizationModel.FULL;
		else if (modelAlias.equals("Stochastic"))
			return UtilizationModel.STOCHASTIC;
		else
			return UtilizationModel.EXTENSION;
	}

	/**
	 * Gets all active utilization model aliases.
	 *
	 * @return an array of strings containing all active utilization model aliases.
	 * @since 1.0
	 */
