...
/**
 * Defines native types of broker policies and implements an extension type to
...
public enum BrokerPolicy implements Serializable {
	...
	/**
	 * The round robin broker policy. Its
	 * {@link #createBroker(java.lang.String, java.lang.String) } method returns an
	 * instance of {@link RoundRobinDatacenterBroker}.
	 * 
	...
	public static BrokerPolicy getInstance(String alias) {
		if (alias.equals("Round robin"))
			return BrokerPolicy.ROUND_ROBIN;
		else
			return BrokerPolicy.EXTENSION;
	}

	/**
	 * Gets all active broker policies aliases.
	 *
	 * @return an array of strings containing all active broker policies aliases.
	 * @since 1.0
	 */
