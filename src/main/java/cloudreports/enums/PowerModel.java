...
/**
 * Defines native types of power models and implements an extension type to
 * support user-implemented new types.
 * 
 * @author Thiago T. Sá
 * @since 1.0
 */
public enum PowerModel implements Serializable {
	...
	/**
	 * The linear power model. Its
	 * {@link #getModel(double, double, java.lang.String)} method returns an
	 * instance of CloudSim's PowerModelLinear class.
	 */
	LINEAR {
		@Override
		public org.cloudbus.cloudsim.power.models.PowerModel getModel(double maxPower, double staticPowerPercent,
				String modelAlias) {
	...
	/**
	 * The cubic power model. Its
	 * {@link #getModel(double, double, java.lang.String)} method returns an
	 * instance of CloudSim's PowerModelCubic class.
	 */
	CUBIC {
		@Override
		public org.cloudbus.cloudsim.power.models.PowerModel getModel(double maxPower, double staticPowerPercent,
	...
	/**
	 * The square power model. Its
	 * {@link #getModel(double, double, java.lang.String)} method returns an
	 * instance of CloudSim's PowerModelSquare class.
	 */
	SQUARE {
		@Override
		public org.cloudbus.cloudsim.power.models.PowerModel getModel(double maxPower, double staticPowerPercent,
	...
	/**
	 * The square-root power model. Its
	 * {@link #getModel(double, double, java.lang.String)} method returns an
	 * instance of CloudSim's PowerModelSqrt class.
	 */
	SQUARE_ROOT {
		@Override
		public org.cloudbus.cloudsim.power.models.PowerModel getModel(double maxPower, double staticPowerPercent,
	...
	/**
	 * The extension type. It is used for all user-implemented new types.
	 */
	EXTENSION {
		@Override
		public org.cloudbus.cloudsim.power.models.PowerModel getModel(double maxPower, double staticPowerPercent,
			...
			try {
				...
				return (org.cloudbus.cloudsim.power.models.PowerModel) ExtensionsLoader.getExtension("PowerModel",
						modelAlias, types, arguments);
			} catch (Exception e) {
				return null;
			}
		}
	 ...
	 * @since 1.0
	 */
	public abstract org.cloudbus.cloudsim.power.models.PowerModel getModel(double maxPower, double staticPowerPercent,
			String modelAlias);
	...
	public static PowerModel getInstance(String modelAlias) {
		if (modelAlias.equals("Linear"))
			return PowerModel.LINEAR;
		else if (modelAlias.equals("Square root"))
			return PowerModel.SQUARE_ROOT;
		else if (modelAlias.equals("Square"))
			return PowerModel.SQUARE;
		else if (modelAlias.equals("Cubic"))
			return PowerModel.CUBIC;
		else
			return PowerModel.EXTENSION;
	}

	/**
	 * Gets all active power model aliases.
	 *
	 * @return an array of strings containing all active power model aliases.
	 * @since 1.0
	 */
