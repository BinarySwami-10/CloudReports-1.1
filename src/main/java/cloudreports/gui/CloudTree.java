...
/**
 * A subtype of {@link JTree} to be displayed in the main form of the
 * application.
 * 
 * @author Thiago T. Sá
 * @since 1.0
...
public class CloudTree extends JTree {
	 ...
	 * @param type the type of the node (0 is for provider and 1 is for customers.
	 * @since 1.0
	 */
	...
	/**
	 * An inner class that implements a custom TreeCellRenderer and inherits from
