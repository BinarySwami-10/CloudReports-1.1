...
/**
 * The OverallCustomerView form. Most of its code is generated automatically by
 * the NetBeans IDE.
 * 
 * @author Thiago T. Sá
 * @since 1.0
...
public class OverallDatacenterView extends javax.swing.JPanel {
	...
	public OverallDatacenterView() {
		...
		if (storage < 1000)
			storageCapacity.setText(String.valueOf(storage) + " MB");
		else if (storage < 1000000)
			storageCapacity.setText(String.valueOf(storage / 1000) + " GB");
		else
			storageCapacity.setText(String.valueOf(dft.format(storage / 1000000)) + " TB");

		long ram = drDAO.getTotalRam();
		if (ram < 1000)
			amountOfRAM.setText(String.valueOf(ram) + " MB");
		else if (ram < 1000000)
			amountOfRAM.setText(String.valueOf(ram / 1000) + " GB");
		else
			amountOfRAM.setText(String.valueOf(dft.format(ram / 1000000)) + " TB");
	...
	private void initComponents() {
		...
		addDatacenterButton
				.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cloudreports/gui/resources/add.png"))); // NOI18N
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(numOfDatacentersLabel).addComponent(numOfHostsLabel)
								.addComponent(numOfPEsLabel).addComponent(procCapacityLabel)
								.addComponent(storageCapacityLabel).addComponent(amountOfRAMLabel))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 15, Short.MAX_VALUE)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(numOfHosts).addComponent(numOfPEs).addComponent(procCapacity)
								.addComponent(storageCapacity).addComponent(amountOfRAM).addComponent(numOfDatacenters,
										javax.swing.GroupLayout.PREFERRED_SIZE, 94,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addContainerGap(204, Short.MAX_VALUE)));

		jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { amountOfRAM,
				numOfDatacenters, numOfHosts, numOfPEs, procCapacity, storageCapacity });

		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								.addComponent(numOfDatacentersLabel).addComponent(numOfDatacenters))
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								.addComponent(procCapacityLabel).addComponent(procCapacity))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								.addComponent(storageCapacityLabel).addComponent(storageCapacity))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								.addComponent(amountOfRAMLabel).addComponent(amountOfRAM))
		...
		overviewPanelLayout.setHorizontalGroup(overviewPanelLayout
				...
				.addGroup(overviewPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(overviewPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(overviewPanelLayout.createSequentialGroup().addComponent(addDatacenterButton)
										.addGap(18, 18, 18).addComponent(removeDatacenterButton)))
						.addContainerGap()));

		overviewPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { addDatacenterButton, removeDatacenterButton });

		overviewPanelLayout.setVerticalGroup(overviewPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(overviewPanelLayout.createSequentialGroup().addGap(32, 32, 32)
						.addGroup(overviewPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(addDatacenterButton).addComponent(removeDatacenterButton))
						.addGap(18, 18, 18)
						.addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap(117, Short.MAX_VALUE)));

		overviewPanelLayout.linkSize(javax.swing.SwingConstants.VERTICAL,
				new java.awt.Component[] { addDatacenterButton, removeDatacenterButton });
		...
		}, new String[] { "Source", "Destination", "Bandwidth", "Latency" }) {
		...
		networkPanelLayout.setHorizontalGroup(networkPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(networkPanelLayout.createSequentialGroup().addContainerGap()
						...
						.addContainerGap()));
		networkPanelLayout.setVerticalGroup(networkPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(networkPanelLayout.createSequentialGroup().addContainerGap().addComponent(networkInfoLabel)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
	...
	/**
	 * Launches a {@link RemoveDatacenter} form when the Remove Datacenter button is
	 * clicked.
	 *
	...
	private void addLinkToTable(String src, String dest, double bandwidth, double latency) {
		networkTableModel.insertRow(0, new Object[] { src, dest, bandwidth, latency });
	}
