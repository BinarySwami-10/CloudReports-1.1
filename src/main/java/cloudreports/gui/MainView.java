...
/**
 * The MainView form. Most of its code is generated automatically by the
 * NetBeans IDE.
 * 
 * @author Thiago T. Sá
 * @since 1.0
...
public class MainView extends javax.swing.JFrame {
	 ...
	 * 
	 * @return a boolean value indicating whether the current datacenter has been
	 *         modified or not.
	 */
	 ...
	 * 
	 * @param datacenterModifiedValue a value indicating that the datacenter has
	 *                                been modified.
	 */
	 ...
	 * 
	 * @return a boolean value indicating whether the current customer has been
	 *         modified or not.
	 */
	 ...
	 * 
	 * @param customerModifiedValue a value indicating that the customer has been
	 *                              modified.
	 */
	...
	public MainView() throws IOException {
		...
		specificDatacenterView = new SpecificDatacenterView(
				drDAO.getDatacenterRegistry(drDAO.getAllDatacentersNames()[0]));
	...
	private void initComponents() {
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(12, 12, 12).addComponent(jLabel2)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(environmentsBox, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(7, 7, 7)
						.addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 239,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18).addComponent(startButton).addContainerGap(137, Short.MAX_VALUE)));
		...
		environmentsMenuItem.setAccelerator(
		...
		quitMenuItem.setIcon(
				new javax.swing.ImageIcon(getClass().getResource("/cloudreports/gui/resources/close_small.png"))); // NOI18N
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(cardPanel, javax.swing.GroupLayout.Alignment.LEADING,
	...
	private void jTreeValueChanged(javax.swing.event.TreeSelectionEvent evt) {// GEN-FIRST:event_jTreeValueChanged
		try {
			...
			if (node.isLeaf()) {
				...
				if (node.toString().equalsIgnoreCase("CloudReports"))
					cl.show(cardPanel, "logoPanel");
				else if (node.toString().equalsIgnoreCase("Provider"))
					updateOverallDatacenterView();
				else if (node.toString().equalsIgnoreCase("Customers"))
	...
	/**
	 * Launches the SimulationSettings view when the simulation settings menu item
	 * is clicked.
	 *
	 * @param evt an action event.
	 * @since 1.0
	...
	/**
	 * Changes the working environment whenever the environments combo box value is
	 * changed.
	 *
	 * @param evt an action event.
	 * @since 1.0
	...
	/**
	 * Launches the ManageEnvironments view when the manage environments menu item
	 * is clicked.
	 *
	 * @param evt an action event.
	 * @since 1.0
	...
	/**
	 * Gets all environments names. It reads all .cre files in the db directory.
	 *
	 * @since 1.0
	 */
	...
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			if (!wasFound) {
				...
				Dialog.showWarning(new JFrame(),
						"The default Java \"Look and Feel\" of this application is not available\n"
