...
/**
 * The EditVm form. Most of its code is generated automatically by the NetBeans
 * IDE.
 * 
 * @author Thiago T. Sá
 * @since 1.0
...
public class EditVm extends javax.swing.JDialog {
	...
	public EditVm(VirtualMachineRegistry vmr, SpecificCustomerView scv) {
		...
		if (vmr.getVmm().equalsIgnoreCase("Xen"))
			hypervisorComboBox.setSelectedIndex(0);
		else
			hypervisorComboBox.setSelectedIndex(1);
	...
	private void initComponents() {
		...
		imageSizeSpinner.setModel(
				new javax.swing.SpinnerNumberModel(Long.valueOf(1L), Long.valueOf(1L), null, Long.valueOf(100L)));
		...
		mipsSpinner.setModel(
				new javax.swing.SpinnerNumberModel(Long.valueOf(1L), Long.valueOf(1L), null, Long.valueOf(50L)));
		...
		ramSpinner.setModel(
				new javax.swing.SpinnerNumberModel(Integer.valueOf(1), Integer.valueOf(1), null, Integer.valueOf(64)));
		...
		bwSpinner.setModel(
				new javax.swing.SpinnerNumberModel(Long.valueOf(0L), Long.valueOf(0L), null, Long.valueOf(100L)));
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								...
								.addGroup(jPanel1Layout.createSequentialGroup()
										.addGroup(jPanel1Layout
												...
												.addComponent(imageSizeSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(pesSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(mipsSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(amountSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, 83,
														javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGap(18, 18, 18)
										.addGroup(jPanel1Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										...
										.addGroup(jPanel1Layout
												...
												.addComponent(bwSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(prioritySpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(policyComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)
												.addComponent(hypervisorComboBox, 0,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
						.addContainerGap()));

		jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] { amountSpinner,
				bwSpinner, imageSizeSpinner, mipsSpinner, pesSpinner, prioritySpinner, ramSpinner });

		jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL,
				new java.awt.Component[] { hypervisorComboBox, policyComboBox });
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								...
								.addComponent(amountSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel6).addComponent(bwSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								...
								.addComponent(imageSizeSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel7).addComponent(prioritySpinner,
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								...
								.addComponent(pesSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel8).addComponent(hypervisorComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								...
								.addComponent(mipsSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel9).addComponent(policyComboBox,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel5).addComponent(ramSpinner, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
	...
	/**
	 * Changes the image size of this virtual machine registry whenever the state of
	 * the Image Size spinner changes.
	 *
	 * @param evt a change event.
	 * @since 1.0
	 */
	...
	/**
	 * Changes the number of processing elements of this virtual machine registry
	...
	/**
	 * Changes the number of mips of this virtual machine registry whenever the
	 * state of the mips spinner changes.
	 *
	 * @param evt a change event.
	 * @since 1.0
	 */
	...
	/**
	 * Changes the amount of RAM of this virtual machine registry whenever the state
	...
	/**
	 * Changes the amount of bandwidth of this virtual machine registry whenever the
	 * state of the bandwidth spinner changes.
	 *
	 * @param evt a change event.
	 * @since 1.0
	 */
	...
	/**
	 * Changes the priority of this virtual machine registry whenever the state of
	 * the priority spinner changes.
	 *
	 * @param evt a change event.
	 * @since 1.0
	 */
	...
	/**
	 * Changes the hypervisor of this virtual machine registry whenever the item of
	...
	/**
	 * Changes the scheduling policy of this virtual machine registry whenever the
	 * item of the policy combo box changes.
	 *
	 * @param evt an item event.
	 * @since 1.0
	 */
	...
	/**
	 * Updates the virtual machine registry and the specific customer view when the
