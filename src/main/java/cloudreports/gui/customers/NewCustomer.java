...
/**
 * The NewCustomer form. Most of its code is generated automatically by the
 * NetBeans IDE.
 * 
 * @author Thiago T. Sá
 * @since 1.0
...
public class NewCustomer extends javax.swing.JDialog {
	...
	/**
	 * Creates the new customer when the OK button is clicked. The name of the
	...
	private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_okButtonActionPerformed
		...
		if ((!name.isEmpty()) && (drDAO.getDatacenterRegistry(name) == null)
