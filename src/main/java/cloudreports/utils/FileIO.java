...
public class FileIO {
	...
	public static String getPathOfExecutable() {
		...
		if (baseDirectory.indexOf(executableName) > 0)
			return baseDirectory.substring(0, baseDirectory.indexOf(executableName));
		else
	 ...
	 * @return the byte array if the operation was successful; <code>null</code>
	 *         otherwise.
	 */
	public static byte[] readBytesFromFile(String filePath) {
		...
		try {
			...
			int bufferSize = resourceStream.read(new byte[20000000]); // TODO: Set the buffer size dinamically.
