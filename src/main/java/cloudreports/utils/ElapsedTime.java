...
/**
 * Represents a time span. It is used to generate a readable formatted string
 * that represents the time a CloudReports simulation took to complete. The time
 * components (days, hours, minutes and seconds) are calculated with basic
 * arithmetics that do not consider factors such as leap years, thus the results
