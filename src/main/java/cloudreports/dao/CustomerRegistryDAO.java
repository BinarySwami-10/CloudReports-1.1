 ...
 * {@link CustomerRegistry} class. It also provides access to general
 * information about virtual machines deployed by a given customer.
 * 
...
public class CustomerRegistryDAO {
	...
	/**
	 * Inserts a new customer registry into the database. The customer's name must
	 * be unique.
	 *
	 * @param cr the customer registry to be inserted.
	 * @return <code>true</code> if the customer registry has been successfully
	 ...
	 * @return <code>true</code>, if the customer has been successfully removed;
	 ...
	 *
	 * @return a list containing all the customer registries in the database;
	 *         <code>null</code> if no customers were found.
	 * @see CustomerRegistry
	 * @since 1.0
	 */
	 ...
	 *
	 * @param customerId the id of the customer of which the virtual machines will
	 *                   be listed.
	 * @return a list containing all the virtual machines deployed by the customer;
	 *         <code>null</code> if no virtual machines were found.
	 * @see CustomerRegistry
	...
	/**
	 * Gets a virtual machine registry based on its id and the id of the customer
	 * who owns it.
	 * 
	 * @param vmId       the id of the virtual machine to be retrieved.
	 * @param customerId the id of the customer who owns the virtual machine to be
	 *                   retrieved.
	 * @return the virtual machine registry, if it exists; <code>null</code>
	 *         otherwise.
	 * @see CustomerRegistry
	 * @see VirtualMachineRegistry
	 * @since 1.0
	 ...
	 * 
	 * @param customerId the id of the customer who owns the virtual machines to be
	 *                   counted.
	 * @return the number of virtual machines deployed by the customer.
	 * @see CustomerRegistry
	 * @see VirtualMachineRegistry
	 * @since 1.0
	 */
	 ...
	 * 
	 * @param customerId the id of the customer who owns the virtual machines.
	 * @return an array containing the names of all virtual machines deployed by the
	 *         customer.
	 * @see CustomerRegistry
	 * @see VirtualMachineRegistry
	 * @since 1.0
	...
	/**
	 * Gets the total demand of RAM from the virtual machines deployed by a given
	 * customer.
	 * 
	 * @param customerId the id of the customer who owns the virtual machines.
	 * @return the total demand of RAM from all virtual machines deployed by the
	 *         customer.
	 * @see CustomerRegistry
	 * @see VirtualMachineRegistry
	 * @since 1.0
	...
	/**
	 * Gets the total demand of bandwidth from the virtual machines deployed by a
	 * given customer.
	 * 
	 * @param customerId the id of the customer who owns the virtual machines.
	 * @return the total demand of bandwidth from all virtual machines deployed by
	 *         the customer.
	 * @see CustomerRegistry
	 * @see VirtualMachineRegistry
	 * @since 1.0
	...
	/**
	 * Gets the total demand of MIPS from the virtual machines deployed by a given
	 * customer.
	 * 
	 * @param customerId the id of the customer who owns the virtual machines.
	 * @return the total demand of MIPS from all virtual machines deployed by the
	 *         customer.
	 * @see CustomerRegistry
	 * @see VirtualMachineRegistry
	 * @since 1.0
	...
	/**
	 * Gets the total demand of storage from the virtual machines deployed by a
	 * given customer.
	 * 
	 * @param customerId the id of the customer who owns the virtual machines.
	 * @return the total demand of storage from all virtual machines deployed by the
	 *         customer.
	 * @see CustomerRegistry
	 * @see VirtualMachineRegistry
	 * @since 1.0
	 ...
	 * 
	 * @return the total number of cloudlets created by all customers.
	 * @see CustomerRegistry
	 ...
	 * 
	 * @return the total number of virtual machines deployed by all customers.
	 * @see CustomerRegistry
	 * @see UtilizationProfile
	 * @since 1.0
	 */
	 ...
	 * 
	 * @return the average length of cloudlets created by all customers.
	 * @see CustomerRegistry
	 * @see UtilizationProfile
	 * @since 1.0
	 */
	 ...
	 * 
	 * @return the average file size of cloudlets created by all customers.
	 * @see CustomerRegistry
	 * @see UtilizationProfile
	 * @since 1.0
	 */
	 ...
	 * 
	 * @return the average output size of cloudlets created by all customers.
	 * @see CustomerRegistry
	 * @see UtilizationProfile
	 * @since 1.0
	 */
	...
	/**
	 * Gets the average image size of virtual machines deployed by all customers.
	 * 
	 * @return the average image size of virtual machines deployed by all customers.
	 * @see CustomerRegistry
	 * @see VirtualMachineRegistry
	 * @since 1.0
	 */
	...
	/**
	 * Gets the average amount of RAM requested by all virtual machines deployed by
	 * all customers.
	 * 
	 * @return the average amount of RAM requested by all virtual machines.
	 * @see CustomerRegistry
	 * @see UtilizationProfile
	 * @since 1.0
	 */
	 ...
	 * 
	 * @return the average amount of bandwidth requested by all virtual machines.
	 * @see CustomerRegistry
	 * @see UtilizationProfile
	 * @since 1.0
	 */
