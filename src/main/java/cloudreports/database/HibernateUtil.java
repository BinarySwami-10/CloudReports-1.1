...
public class HibernateUtil {
	...
	/**
	 * Gets the active database. It consists of the name of the CloudReports
	 * Environment (.cre) file without its extension.
	 *
	 * @see #activeDatabase
	 * @since 1.0
	 */
	...
	/**
	 * Sets the active database. It changes the active database and builds a new
